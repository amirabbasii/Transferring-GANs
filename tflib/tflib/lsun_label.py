...
def make_generator(path, n_files, batch_size,image_size, IW = False, pharse='train'):
    ...
    def get_epoch():
        ...
        files = np.arange(len(image_list))
        ...
        for n, i in enumerate(files):
            ...
            image = imageio.imread("{}".format(image_list[i]))#****************************I changed this line.
            label = Label[image_list[i].split('/')[2]]
	          #image = scipy.misc.imresize(image,(image_size,image_size))
            image = skimage.transform.resize(image,(image_size,image_size))#****************** I added this line.
